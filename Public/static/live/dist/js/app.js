define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./Lottery", "./video"], function (require, exports, module) {
	...
	var d = function () {
		...
		return W.matches = function (a, b) {
			...
			forEach: B.forEach, reduce: B.reduce, push: B.push, sort: B.sort, indexOf: B.indexOf, concat: B.concat, map: function (a) {
	...
	window.Zepto = d, void 0 === window.$ && (window.$ = d), function (a) {
		...
		a.active = 0, a.ajaxJSONP = function (b, c) {
			...
			}, accepts: { script: "text/javascript, application/javascript, application/x-javascript", json: w, xml: "application/xml, text/xml", html: x, text: "text/plain" }, crossDomain: !1, timeout: 0, processData: !0, cache: !0
		}, a.ajax = function (b) {
	...
	var b = a("dist/js/zepto"), c = a("dist/js/global"), d = {
		_page: b(".m-page"), _pageNum: b(".m-page").size(), _pageNow: 0, _pageNext: null, _touchStartValY: 0, _touchDeltaY: 0, _moveStart: !0, _movePosition: null, _movePosition_c: null, _mouseDown: !1, _moveFirst: !0, _moveInit: !1, _firstChange: !1, page_start: function () {
	...
	var c = a("dist/js/zepto"), d = a("dist/js/global"), b = {
		_audioNode: c(".u-audio"), _audio: null, audio_init: function () {
	...
	var b = a("dist/js/zepto"), c = a("dist/js/page"), d = {
		lazy_img: function () {
			var a = b(".lazy-img");
			a.each(function () {
				var a = b(this);
				if (a.is("img"))
					a.attr("src", "/template/20/res/img/loading_large.gif");
				else {
					var c = a.css("background-position"), d = a.css("background-size");
					a.attr({ "data-position": c, "data-size": d }), "no" == a.attr("data-bg") && a.css({ "background-repeat": "no-repeat" }), a.css({ "background-image": "url(/template/20/res/img/loading_large.gif)", "background-size": "120px 120px", "background-position": "center" }), "no" == a.attr("data-image") && a.css({ "background-image": "none" })
				}
			})
		}, lazy_start: function () {
			var a = this;
	...
	var b = a("dist/js/zepto"), d = a("dist/js/global"), e = a("dist/js/page"), f = a("dist/js/map"), g = a("dist/js/form"), c = {
		mapCreate: function () {
			if (!(".j-map".length <= 0)) {
			...
			var d = b("#activity_id").val(), e = b("#activity_web").val() + "api.php?id=" + d + "&plugtype=" + a;
			//alert(e)
			b.get(e, {}, function () {
			})
		}, wxShare: function () {
	...
	var global = require("dist/js/global"), page = require("dist/js/page"), media = require("dist/js/media"), __map = {
		_map: $(".ylmap"), _mapValue: null, _mapIndex: null, mapAddEventHandler: function (a, b, c, d) {
			var e = c;
	...
	var b = a("dist/js/zepto"), c = a("dist/js/global"), d = a("dist/js/page"), e = {
		signUpCheck_input: function (a, c) {
			...
			var g = b("#activity_web").val() + "plugin.php?id=" + b("#activity_id").val() + "&" + a.serialize();
			//alert(g)
			b.ajax({
				url: g, cache: !1, dataType: "json", async: !0, type: "POST", data: a.serialize(), success: function (a) {
	...
	b = a("dist/js/ylMusic");
	var c = a("dist/js/Lottery"), d = (a("dist/js/global"), a("dist/js/page")), e = a("dist/js/media"), f = a("dist/js/video"), g = {
		init: function () {
	...
	var b = a("dist/js/zepto"), c = a("dist/js/global"), d = {
		_video: b(".j-video"), _videoArr: [], video_init: function () {
			var a = this;
