...
function __image(t) {
	...
	i = {
		lazy_img: function() {
			...
			t.each(function() {
				var t = e(this);
				if (t.is("img")) t.attr("src", "/Public/static/live/images/loading_large.gif");
				else {
	...
	s = {
		init: function() {
			e("#coffee_flow").coffee({
				steams: ["<img src='/Public/static/live/images/audio_widget_01@2x.png' />"],
				steamHeight: 100,
				steamWidth: 44
			}),
			o.media_init(),
			...
			if (1 == n) {
				var a = e("#j-mengban")[0],
				l = "/Public/static/live/images/page_01_bg@2x.jpg",
				c = e("#r-cover").val(),
				u = "image",
				d = 640,
				h = e(window).height(),
...
function(t, e, n) {
	...
	function(t) {
		...
		t.fn.coffee.defaults = {
			steams: ["jQuery", "HTML5", "HTML6", "CSS2", "CSS3", "JS", "$.fn()", "char", "short", "if", "float", "else", "type", "case", "function", "travel", "return", "array()", "empty()", "eval", "C++", "JAVA", "PHP", "JSP", ".NET", "while", "this", "$.find();", "float", "$.ajax()", "addClass", "width", "height", "Click", "each", "animate", "cookie", "bug", "Design", "Julying", "$(this)", "i++", "Chrome", "Firefox", "Firebug", "IE6", "Guitar", "Music", "攻城师", "旅行", "啤酒"],
