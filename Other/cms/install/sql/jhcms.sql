...
--
-- 表的结构 `gooraye_article`
--

CREATE TABLE IF NOT EXISTS `gooraye_article` (
...
--
-- 表的结构 `gooraye_attachement`
--

CREATE TABLE IF NOT EXISTS `gooraye_attachement` (
...
--
-- 表的结构 `gooraye_channel`
--

CREATE TABLE IF NOT EXISTS `gooraye_channel` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `gooraye_channel_contentattribute`
--

CREATE TABLE IF NOT EXISTS `gooraye_channel_contentattribute` (
...
--
-- 表的结构 `gooraye_keywords`
--

CREATE TABLE IF NOT EXISTS `gooraye_keywords` (
...
--
-- 表的结构 `gooraye_picture`
--

CREATE TABLE IF NOT EXISTS `gooraye_picture` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gooraye_site` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `gooraye_template`
--

CREATE TABLE IF NOT EXISTS `gooraye_template` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
