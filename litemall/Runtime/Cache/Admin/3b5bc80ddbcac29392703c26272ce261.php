...
<meta charset="UTF-8">
<title>preview</title>
<link rel="stylesheet" href="/litemall/Public/static/preview/app.css">
</head>
<body>
	<div class="phone-content">
		<div class="phone">
			<iframe src="<?php echo U('App/Index/index',array('openid'=>'123213','token'=>getToken()));?>" frameborder="0"
...
<!-- 		<li>
			<a href="javascript:void(0)">
				...
				<span class="menu-text"> 扩展工具 </span>
			</a>
		</li> -->
	</ul><!-- /.nav-list -->
		...
		<div class="main-content">
			...
			<div id="content_main">
				<iframe src="<?php echo U('Admin/Index/set');?>" id="main_iframe" name="main_iframe"
					style="width: 100%;height:100%;" frameborder="0" onLoad="iFrameHeight()"  scrolling="yes"></iframe>
				<script type="text/javascript" language="javascript"> 
					...
					function iFrameHeight() {
						...
						var subWeb = document.frames ? document.frames["main_iframe"].document
								: ifm.contentDocument;
						subWeb = document.body.clientHeight;
						if (ifm != null && subWeb != null) {
							ifm.style.height = (subWeb-100)+"px";
						}
						// console.log(ifm);
					}
				</script>
...
/* 		$('.nav.nav-list li').eq(6).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('扩展工具');
