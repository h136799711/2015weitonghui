...
<script type="text/javascript">
var UEURL = '/litemall/Public/static/umeditor/';
</script>
<link href="/litemall/Public/static/umeditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="/litemall/Public/static/umeditor/third-party/jquery.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/litemall/Public/static/umeditor/umeditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/litemall/Public/static/umeditor/umeditor.min.js"></script>
<script type="text/javascript" src="/litemall/Public/static/umeditor/lang/zh-cn/zh-cn.js"></script>
			...
			function reGood(o) {
				...
				$.post("<?php echo U('Admin/Good/getgoodid');?>",{"id":goodid},function(data){
					...
					if (flag) {
						...
						$('input[name="addimage"]').parent().append('<img src="/litemall<?php echo ltrim(C("GFILE_UPLOAD")["rootPath"],"."); echo getToken();?>/'+json.image+'" id="goodimage" style="max-width:650px" class="img-thumbnail">');
						flag = false;
					}else{
						$('input[name="goodid"]').val(json.id);
						$('#goodimage').attr("src","/litemall<?php echo ltrim(C('GFILE_UPLOAD')['rootPath'],'.'); echo getToken();?>/"+json.image);
					}
				});
