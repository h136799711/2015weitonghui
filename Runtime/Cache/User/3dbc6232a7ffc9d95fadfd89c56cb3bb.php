...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
    <form method="post" class="form-horizontal" action="<?php echo U('Areply/insert');?>">
        <fieldset>
            <legend>每次粉丝关注时自动回复内容</legend>
            <div class="form-group">
                <label class="control-label col-lg-2 col-md-2" style="line-height: 63px;">是否图文回复</label>
                <div class="col-lg-10 col-md-10">
                    <div class="checkbox">
                        <label>
                            <input name="home" id="home" type="checkbox" <?php if($areply['home'] == 1): ?>checked="checked"<?php endif; ?> value="1"   />
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group Hfcontent">
                <label  class="control-label col-lg-2 col-md-2">文本回复内容</label>
                <div class="col-lg-10 col-md-10">
                    <textarea class="form-control  col-lg-10 col-md-10" rows="3"  id="Hfcontent" name="content" ><?php echo ($areply["content"]); ?></textarea>
                    <span class="bg-warning">不超过120字</span>
                </div>
            </div>
            <div class="form-group keyword ">
                <label for="" class="control-label col-lg-2 col-md-2">关键词</label>
                <div class=" col-lg-10 col-md-10">
                    <input type="input" class="form-control" id="keyword" value="<?php echo ($areply["keyword"]); ?>" name="keyword"  >
                    <span class="help-block">
                        此处 关键词 为 微信自定义回复 中添加的关键词
                    </span>
                </div>
            </div>
            <div class="form-group biaoqing">
                <label for="" class="control-label col-lg-2 col-md-2">点击表情<br>添加到文本回复内容</label>
                <div class=" col-lg-10 col-md-10">
            ...
            <div class="from-group">
                ...
                <div class="col-lg-10 col-md-10">
                    <button type="submit" class="btn btn-warning btn-sm"  ><i class="mdi-content-save"></i>保存 </button>
                </div>
            </div>
        </fieldset>
    </form>
