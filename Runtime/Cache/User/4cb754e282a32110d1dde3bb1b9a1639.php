...
<input type="submit" value="搜索" id="msgSearchBtn" href="" class="btn btn-primary  btn-small" title="搜索">
</form> -->
</div>
<div class="clearfix"></div>
</div>
<div >
<div class="pageNavigator left"> <a href="<?php echo U('Host/add',array('token'=>$token));?>" title="新增订单商家" class="btn btn-primary"><i class="mdi-content-add"></i>新增订单商家</a> </div>
<div class="clearfix"></div>
</div>
<div class="">
...
<td class="norightborder"><a class="btn btn-warning btn-sm" href="<?php echo U('Host/admin',array('id'=>$hostlist['id'],'token'=>$token));?>">订单管理</a> <a class="btn btn-warning btn-sm" href="<?php echo U('Host/set',array('id'=>$hostlist['id'],'token'=>$token));?>">商家设置</a> <a class="btn btn-warning btn-sm" href="<?php echo U('Host/lists',array('id'=>$hostlist['id'],'token'=>$token));?>">订单设置</a> <a class="btn btn-warning btn-sm" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Host/index_del',array('id'=>$hostlist['id'],'token'=>$token));?>');"><i class="mdi-action-delete"></i>删除</a></td>
