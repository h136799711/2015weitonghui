            ...
            <table class="table" >
                <tbody>
                    <tr>
                        <th>选择分组</th>
                        <td>
                            <select class="form-control"  name="wechatgroupid"><?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><option value="<?php echo ($g["wechatgroupid"]); ?>"><?php echo ($g["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select>
                        </td>
                    </tr>
                    ...
                    <tr style="display:none">
                        <th>媒体文件</th>
                        <td><input type="input" class="form-control" id="media" name="mediasrc" style="width:250px"> <script src="/Public/static/gfile.js"></script><a href="###" onclick="chooseFile('media','background')" class="a_upload"><i class="mdi-toggle-check-box"></i>选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="gfilePicUpload('media',1500,1000,'<?php echo ($token); ?>')" class="a_upload"><i class="mdi-file-file-upload"></i>上传</a> 仅发送图片消息、语音消息或视频消息的时候填写</td>
                    </tr>
                    <tr style="display:none">
                    ...
                    <tr>
                        ...
                        <td> <a href="###" onclick="addImgMessage()" class="btn btn-warning btn-sm">添加图文消息</a>&nbsp;&nbsp;<a href="###" onclick="clearMessage()" class="btn btn-warning btn-sm">清空重选</a>
                            <script>
