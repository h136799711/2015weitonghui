...
<?php if($type == 1): ?><div class="pageNavigator left">
	<a href="<?php echo U('Store/normsAdd',array('token' => $token, 'catid' => $catid, 'type' => $type));?>" title="新增外观值" class="btn btn-primary">
	<img src="/Public/User/images/product/add.png" class="vm">新增<span class="red"><?php echo ($catData["name"]); ?></span>分类的外观值</a>
</div>
<?php else: ?>
<div class="pageNavigator left">
	<a href="<?php echo U('Store/normsAdd',array('token' => $token, 'catid' => $catid, 'type' => $type));?>" title="新增规格值" class="btn btn-primary">
	<img src="/Public/User/images/product/add.png" class="vm">新增<span class="red"><?php echo ($catData["name"]); ?></span>分类的规格值</a>
</div><?php endif; ?>
<div class="pageNavigator right">
	<a href="<?php echo U('Store/index',array('token' => $token, 'catid' => $catid));?>" class="btn btn-primary"><i class="mdi-content-reply"></i>返回</a>
</div>
...
<td class="norightborder">
	<a class="btn btn-warning btn-sm" href="<?php echo U('Store/normsAdd',array('token' => $token, 'id' => $hostlist['id'], 'catid' => $catid, 'type' => $type));?>"><i class="mdi-editor-mode-edit"></i>修改</a>
	<a class="btn btn-warning btn-sm"  href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/normsDel',array('token' => $token, 'id' => $hostlist['id'], 'catid' => $catid, 'type' => $type));?>');"><i class="mdi-action-delete"></i>删除</a>
</td>
