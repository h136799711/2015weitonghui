...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
    ...
    <div class="">
        <form method="post" action="" id="info">
            <div >
                <div class="pageNavigator left"> <a href="<?php echo U('Company/index',array('token'=>$token,'isBranch'=>1));?>" title="" class="btn btn-primary"><i class="mdi-content-add"></i>添加</a></div>
                <div class="clearfix"></div>
            </div>
            <table class="table table-condensed table-bordered table-striped" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <?php if(is_array($branches)): $i = 0; $__LIST__ = $branches;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="norightborder"><a href="<?php echo U('Company/index',array('token'=>$token,'id'=>$c['id'],'isBranch'=>1));?>"  class="btn btn-warning btn-sm"><i class="mdi-editor-mode-edit"></i>修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Company/delete',array('token'=>$token,'id'=>$c['id'],'isBranch'=>1));?>');" class="btn btn-warning btn-sm"><i class="mdi-action-delete"></i>删除</a></td>
