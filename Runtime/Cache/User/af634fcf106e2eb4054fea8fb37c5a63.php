...
font-weight:bold;
  ...
  <div class="righttitle">
   ...
   <strong><font color='red'>请设置宠物公司相关内容,注意：第一次使用，请点击添宠物公司简介等相关设置，并点击保存</font></strong>
    ...
    <div class="cLineC" style="line-height: 32px;"> <a href="<?php echo U('Business/index_add',array('token'=>$token,'type'=>$type));?>" class="btn btn-primary">
                ...
                <table class="table table-condensed table-bordered table-striped" border="0" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <?php if(is_array($busines)): $i = 0; $__LIST__ = $busines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
                        ...
                        <td class="norightborder">
                            <a href="<?php echo U('Business/index_add',array('bid'=>$vo['bid'],'type'=>$vo['type']));?>" class="btn btn-warning btn-sm" ><i class="mdi-editor-mode-edit"></i>编辑</a>
                        <a href="<?php echo U('Business/index_del',array('bid'=>$vo['bid'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn btn-warning btn-sm" ><i class="mdi-action-delete"></i>删除</a> </td>
