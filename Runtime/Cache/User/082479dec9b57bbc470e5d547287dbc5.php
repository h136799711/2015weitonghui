...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
    ...
    <div class="tab">
        <ul class="list-unstyled nav nav-tabs">
            ...
            <li class="tabli" id="tab2"><a href="<?php echo U('ReplyInfo/set',array('token'=>$token,'infotype'=>'panorama'));?>">回复配置</a></li>
        </ul>
    </div>
    <!--tab end-->
    <div class="">
        <form method="post" action="" id="info">
            <div >
                <div class="pageNavigator left"> <a href="<?php echo U('Panorama/add',array('token'=>$token));?>" title="" class="btn btn-primary"><i class="mdi-content-add"></i>添加360°全景</a></div>
                <div class="clearfix"></div>
            </div>
            <table class="table table-condensed table-bordered table-striped" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="norightborder"><a class="btn btn-warning btn-sm" href="<?php echo U('Panorama/set',array('token'=>$token,'id'=>$o['id']));?>"><i class="mdi-editor-mode-edit"></i>修改</a> <a class="btn btn-warning btn-sm" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Panorama/delete',array('token'=>$token,'id'=>$o['id']));?>');"><i class="mdi-action-delete"></i>删除</a></td>
