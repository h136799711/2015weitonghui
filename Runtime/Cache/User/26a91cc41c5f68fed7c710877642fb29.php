...
<div class="pageNavigator left">
	<a href="<?php echo U('Store/attributeAdd',array('token'=>$token,'catid'=>$catid));?>" title="新增属性" class="btn btn-primary">
	<i class="mdi-content-add"></i>新增<span class="red"><?php echo ($catData["name"]); ?></span>分类的属性</a>
</div>
...
<td class="norightborder"><a  class="btn btn-warning btn-sm"  href="<?php echo U('Store/attributeAdd',array('token' => $token, 'id' => $attributeData['id'], 'catid' => $attributeData['catid']));?>"><i class="mdi-editor-mode-edit"></i>修改</a> <a  class="btn btn-warning btn-sm"  href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/attributeDel',array('id' => $attributeData['id'], 'token'=> $token, 'catid' => $attributeData['catid']));?>');"><i class="mdi-action-delete"></i>删除</a></td>
