...
<script src="/Public/static/artDialog/plugins/iframeTools.js"></script>
 <div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
          <div class="righttitle"><h4>编辑底部菜单</h4><a href="javascript:history.go(-1);"  class="btn btn-primary" data-top ><i class="mdi-content-reply"></i>返回</a></div> 
<div class="">
...
<tr>
  ...
  <?php
 for ($i=1;$i<20;$i++){ echo '<img onclick="document.getElementById(\'img\').value=this.src" onmouseover="this.style.background=\'#816f6f\'" onmouseout="this.style.background=\'#806D6D\'" style="width:30px;cursor:pointer;" src="/Public/User/images/photo/plugmenu'.$i.'.png" />'; } ?>
  </div></td>
  <td>&nbsp;</td>
</tr>
<tr>
  <th valign="top"><label for="url">外链地址 ：</label></th>
  <td><input type="input" class="form-control" id="url" value="<?php echo ($info["url"]); ?>" name="url" style="width:500px" >  <a href="###" onclick="addLink('url',0)" class="btn btn-warning btn-sm "><i class="mdi-social-group-add"></i>从功能库添加</a><br />
...
<tr>
  ...
  <td><input type="input" class="form-control" id="keyword" value="<?php echo ($info["orderss"]); ?>" name="orderss" style="width:500px" ><br />
                   </td>
  <td>&nbsp;</td>
</tr>
<tr>
  <th valign="top"><label for="keyword">是否显示：</label></th>
  <td><input type="radio" class="form-control" id="keyword" value="1" name="status" <?php if($info['status'] == 1): ?>checked<?php endif; ?> />是<br />
  <input type="radio" class="form-control" id="keyword" value="0" name="status"  <?php if($info['status'] == 0): ?>checked<?php endif; ?> />否
                   </td>
  <td>&nbsp;</td>
</tr>
<tr>
