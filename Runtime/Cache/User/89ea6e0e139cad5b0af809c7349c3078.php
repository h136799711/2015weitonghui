...
<a href="<?php echo U('Store/addNew', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btn btn-primary">
<i class="mdi-content-add"></i>添加商品</a>
</div><?php endif; ?>
...
<td class="norightborder" align="center">
	<a  class="btn btn-warning btn-sm"  href="<?php echo U('Store/addNew',array('id' => $hostlist['id'], 'token' => $token,'catid' => $catid));?>"><i class="mdi-editor-mode-edit"></i>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a  class="btn btn-warning btn-sm"  href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/del',array('id'=>$hostlist['id'],'token'=>$token,'catid'=>$catid));?>');"><i class="mdi-action-delete"></i>删除</a>
</td>
