        ...
        <form class="form" method="post"   action="<?php echo U('Text/insert');?>"  target="_top" enctype="multipart/form-data" >
            <table style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <td><input type="input" class="form-control" id="keyword" value="" name="keyword" style="width:500px" ><br />
                    </td>
                    <td>&nbsp;</td>
                </tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td><textarea  class="form-control" id="Hfcol-xs-9 col-sm-9  col-md-10 col-lg-10 " name="text" style="width:500px; height:150px"></textarea><br />请不要多于1000字否则无法发送!
                    </td>
                </tr>
            </td>
                ...
                <td>
                    <div class="clearfix" style="margin-right:10px"  >
                        <ul class="list-unstyled">
                            <li class="biaoqing">
                                <ul class="col-md-8 col-lg-8 list-unstyled clearfix">
