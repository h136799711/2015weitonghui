...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
          <div class="righttitle">
          	<h4>创建相册</h4><a href="<?php echo U('Photo/index');?>" class="btn btn-primary" data-top><i class="mdi-content-reply"></i>返回</a></div>
...
<td width="430"><input type="text" name="title" value="" class="form-control" style="width:400px;" id="name" onkeyup="DivFollowingText1()">
<script type="text/javascript">
...
<div class="mediaImg"><img id="pic_src" src="/Public/User/images/photo/noneimg.jpg"></div>
...
<div class="mediaImg"><img id="zpic2" src="/Public/User/images/photo/noneimg.jpg"/></div>
<div class="mediaFooter">
...
<tr>
   <th valign="top">相册介绍：</th>
	<td valign="top">
	<textarea class="form-control" id="info" name="info" style="width:400px; height:120px" onkeyup="DivFollowingText2()"></textarea><br>
		<script type="text/javascript">
...
<tr>
	...
	<td>
		...
		<a href="javascript:history.go(-1);" class="btn btn-primary"><i class="mdi-navigation-cancel"></i>取消</a></td>
		<td>&nbsp;
	</td>
</tr>
</tbody>
