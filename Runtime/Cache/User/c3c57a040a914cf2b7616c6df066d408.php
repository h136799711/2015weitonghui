...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
 ...
 <ul class="nav nav-pills">
    ...
    <div >
        <a href='<?php echo U("Text/add");?>' title='添加文本回复' class='btn btn-primary'><i class="mdi-content-add"></i>添加文本回复</a>
    </div>
    <div class="">
            ...
            <table class="table table-condensed table-bordered table-striped" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <tbody>
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="norightborder"> <a class="btn btn-warning btn-sm"  href="<?php echo U('Text/edit',array('id'=>$vo['id']));?>" title="编辑文本"><i class="mdi-editor-mode-edit"></i>编辑</a> <a class="btn btn-warning btn-sm" href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('Text/del',array('id'=>$vo['id']));?>');"><i class="mdi-action-delete"></i>删除</a></td>
