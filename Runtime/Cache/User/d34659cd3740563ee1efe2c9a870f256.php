...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
    ...
    <p><span class="bold">使用方法：</span>功能勾选，设置好信息后，输入关键词即可看到效果。</p>
          ...
          <div >
				...
				<a href="<?php echo U('User/Wedding/add');?>" class="btn btn-primary">
					<i class="mdi-content-add"></i>新增喜帖
				</a>
            </div>
           ...
           <input name="wxid" type="hidden" value="<?php echo ($wxid); ?>">
            <table class="table table-condensed table-bordered table-striped" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <?php if(is_array($wedding)): $i = 0; $__LIST__ = $wedding;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wedding): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><a class="btn btn-warning btn-sm" href="<?php echo U('Photo/list_add',array('id'=>$wedding['id']));?>">喜帖图片</a> </td>
                  <td class="norightborder">
						<a class="btn btn-warning btn-sm" href="<?php echo U('Wedding/info',array('id'=>$wedding['id']));?>">查看名单</a>　
						<a   class="btn btn-warning btn-sm" href="<?php echo U('User/Wedding/edit',array('id'=>$wedding['id']));?>">编辑喜帖</a>　
						<a class="btn btn-warning btn-sm" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('User/Wedding/del',array('id'=>$wedding['id']));?>');"><i class="mdi-action-delete"></i>删除</a>
				   </td>
