...
uploadJson :'<?php echo U("User/GFile/kindedtiropic");?>',// '<?php echo C("site_url"); echo U("User/GFile/kindedtiropic");?>',
items : [
        ...
        <div class=" form">
            <table class="table" >
                <thead>
                    <tr>
                        ...
                        <td><input type="input" class="form-control" id="keyword" value=""  name="keyword" style="width:580px;"><br />
                    例如：企业电话 </td>
                </tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="input" class="form-control" id="title" value=""    name="title" style="width:580px;"> </td>
                </tr>
                <tr>
                    <th valign="top"><label for="text">简介：</label></th>
                    <td><textarea  class="form-control" id="Hfcol-xs-9 col-sm-9  col-md-10 col-lg-10 "     name="text" style="width:580px;  height:100px"></textarea><br />限制200字内
...
<i class="mdi-toggle-check-box"></i>选择所属分类</a>
            ...
            <tr>
                ...
                <td><input type="input" class="form-control" id="url" value="" name="url" style="width:280px;">  <a href="###" onclick="addLink('url',0)" class="btn btn-warning btn-sm"><i class="mdi-social-group-add"></i>从功能库添加</a><br /><span class="red">如需跳转到其他网址，请在输入框右侧选择或这里填写网址(例如：http://baidu.com，记住如果填写必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</td>
            </tr>
            <tr>
                <th valign="top"><label for="usort">排序：</label></th>
                <td>
                    <input type="input" class="form-control" id="usort" value="0" name="usort" >
                </td>
            </tr>
            <tr>
                <th></th>
