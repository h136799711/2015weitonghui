...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
    ...
    <div >
        <a href="<?php echo U('GreetingCard/add');?>" title="新增贺卡" class="btn btn-primary"><i class="mdi-content-add"></i>新增贺卡</a> 
    </div>
            ...
            <table class="table table-condensed table-bordered table-striped" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <?php if(is_array($greeting_card)): $i = 0; $__LIST__ = $greeting_card;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$greeting_card): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="norightborder">
                        <a class="btn btn-primary  btn-small" href="<?php echo U('Wap/GreetingCard/index',array('id'=>$greeting_card['id']));?>"><i class="mdi-action-visibility"></i>查看</a>
                        <a class="btn btn-primary  btn-small" href="<?php echo U('GreetingCard/edit',array('id'=>$greeting_card['id']));?>"><i class="mdi-editor-mode-edit"></i>编辑贺卡</a>
                        <a class="btn btn-primary  btn-small" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('GreetingCard/del',array('id'=>$greeting_card['id']));?>');"><i class="mdi-action-delete"></i>删除</a>
                    </td>
