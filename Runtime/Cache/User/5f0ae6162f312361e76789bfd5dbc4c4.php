...
<div class="righttitle">
  <h4>添加销售</h4><a href="javascript:history.go(-1);return false;" class="btn btn-primary" data-top><i class="mdi-content-reply"></i>返回</a>
 </div>
 <!--tab start-->
      ...
      <form class="form" method="post" action="" id="formID" target="_top" enctype="multipart/form-data">
        ...
        <table class="table" >
            <tbody>
                <tr>
                    <th width="120">姓名：</th>
                    <td> <input type="text" name="name" id="name" class="form-control"  value="<?php echo ($salers['name']); ?>" data-validation-engine="validate[required,minSize[1],maxSize[20]]"
                 ...
                 <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="picture_src" src="<?php echo ((isset($salers['picture']) && ($salers['picture'] !== ""))?($salers['picture']):'/Public/User/images/car/car_sell.png'); ?>" style="max-height:100px;">
                         <input type="input" class="form-control" id="picture" value="<?php echo ((isset($salers['picture']) && ($salers['picture'] !== ""))?($salers['picture']):'/Public/User/images/car/car_sell.png'); ?>" name="picture" >

                         <span class="help-inline">
                              <script src="/Public/static/gfile.js"></script><a href="###" onclick="gfilePicUpload('picture',720,400,'<?php echo ($token); ?>')" class="btn btn-warning btn-sm"><i class="mdi-file-file-upload"></i>上传</a> <a href="###" onclick="viewImg('picture')" class="btn btn-warning btn-sm"><i class="mdi-action-pageview"></i>预览</a>
                ...
                <tr>
                    <th width="120">电话：</th>
                    <td>
                         <input type="text" name="mobile" id="mobile" class="form-control"  value="<?php echo ($salers['mobile']); ?>" data-validation-engine="validate[required,custom[tel]]"/>
                         <span class="maroon">*</span>
                         <span class="help-inline">如 0575-01234567</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">显示顺序：</th>
                    <td>  <input type="text" id="sort" name="sort" value="<?php echo ((isset($salers['sort']) && ($salers['sort'] !== ""))?($salers['sort']):1); ?>" class="input-mini px"data-validation-engine="validate[required,custom[integer],min[1]]" data-errormessage-value-missing="必填项"  /><span class="maroon">*</span>
