...
<li <?php if($tab == 'stastic'): ?>class="active" role="presentation"<?php endif; ?>>
				<a href="<?php echo U('Share/index');?>">7日分享统计</a> 
			</li>
<li <?php if($tab == 'records'): ?>class="active" role="presentation"<?php endif; ?>>
				<a href="<?php echo U('Share/records');?>">分享记录</a> 
			</li>
<li <?php if($tab == 'set'): ?>class="active" role="presentation"<?php endif; ?>>
          ...
          <div class="bg-warning tip">下面为<?php echo ($days); ?>日内分享数据统计</div>
