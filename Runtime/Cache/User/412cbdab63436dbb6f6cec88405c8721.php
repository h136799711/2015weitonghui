...
<form action="" method="post" target="_parent" id="realinfo_form">
    ...
    <table class="table" >
        <tbody>
            ...
            <tr>
                <td  height="62" width="">菜单名称：</td>
                <td>
                    <div class="">
                        <input id="menu_title" class="form-control" name="title" title="菜单名称" value="<?php echo ($show["title"]); ?>" type="text"></div>
                    </td>
                </tr>
                <tr >
                    <td  height="62" width="">关联关键词：</td>
                    <td>
                        <div class="mr15 l"><input id="menu_keyword" class="form-control" name="keyword" title="关联关键词" value="<?php echo ($show["keyword"]); ?>" type="text"> <a href="###" onclick="addLink('menu_keyword',1)" class="btn btn-primary"><i class="mdi-social-group-add"></i>从功能库添加</a></div>

                    </td>
                </tr>
                <tr>
                    <td  height="62" width="">外链接url：</td>
                    <td>
                        <div class="mr15 l"><input id="menu_key" class="form-control" name="url" title="外链接url" value="<?php echo ($show["url"]); ?>" type="text"> <br/>如无特殊需要，这里请不要填写 </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="mr15 l">
                            <input id="sortid" class="form-control" name="sort" title="排序" value="<?php echo ($show["sort"]); ?>" type="text"></div>
                        </td>
                    </tr>
                    <tr >
                        <td height="42">&nbsp;</td>
