...
<div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
 ...
 <ul class="nav nav-pills">
    ...
    <div >
        <a href='<?php echo U("Img/add");?>' title='添加单图文回复' class='btn btn-primary'><i class="mdi-content-add"></i>添加单图文回复</a>
        ...
        <table class="table table-condensed table-bordered table-striped" border="0" cellSpacing="0" cellPadding="0" width="100%">
            ...
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="norightborder">
                    <a class="btn btn-warning btn-sm" href="<?php echo U('Img/edit',array('id'=>$vo['id']));?>" title="编辑图文自定义回复"><i class="mdi-editor-mode-edit"></i>编辑</a>
                <a class="btn btn-warning btn-sm" href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('Img/del',array('id'=>$vo['id']));?>');"><i class="mdi-action-delete"></i>删除</a></td>
