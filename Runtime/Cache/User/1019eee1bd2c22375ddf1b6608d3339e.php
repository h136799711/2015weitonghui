...
<div >
<div class="pageNavigator left"> <a href="<?php echo U('Selfform/inputAdd',array('token'=>$token,'formid'=>$thisForm['id']));?>" title="添加" class="btn btn-primary"><i class="mdi-content-add"></i>添加</a></div>
<div class="clearfix"></div>
</div>
<div class="">
...
<td class="norightborder"><a class="btn btn-warning btn-sm" href="<?php echo U('Selfform/inputSet',array('id'=>$item['id'],'token'=>$token));?>"><i class="mdi-editor-mode-edit"></i>修改</a>&nbsp;&nbsp;<a class="btn btn-warning btn-sm"  href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Selfform/inputDelete',array('id'=>$item['id'],'token'=>$token));?>');"><i class="mdi-action-delete"></i>删除</a></td>
