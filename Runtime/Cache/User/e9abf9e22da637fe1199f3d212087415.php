...
<form class="form" method="post"   action=""  target="_top" enctype="multipart/form-data" >
    <div class="col-xs-9 col-sm-9  col-md-10 col-lg-10 ">
        ...
        <div class="righttitle">
            <h4>编辑幸运大转盘活动开始内容</h4><a href="javascript:history.go(-1);"  class="btn btn-primary" data-top ><i class="mdi-content-reply"></i>返回</a>
        </div>
        <div class=" bgfc">
            <table class="table" ><tbody>
                <tr>
                    ...
                    <td>
                        <input type="hidden" class="form-control" value="1" name="type" style="width:400px" >
                        <input type="input" class="form-control" id="keyword" value="<?php if($vo['keyword'] == ''): ?>大转盘<?php else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
                        <span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
                    </td>
                    <td rowspan="7" valign="top">
                        <div style="margin-left:20px">
                            <img id="pic1_src" src="<?php if($vo['starpicurl'] == ''): ?>/Public/static/Public/Wap/css/guajiang/images/activity-lottery-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" >
                            <br />
                            <input class="form-control"  name="starpicurl" value="<?php if($vo['starpicurl'] == ''): ?>/Public/static/Public/Wap/css/guajiang/images/activity-lottery-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" id="pic1" style="width:363px;"  />
                            <br />
                ...
                <tr>
                    ...
                    <td>
                        <input type="input" class="form-control" id="title" value="<?php if($vo['title'] == ''): ?>幸运大转盘活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:400px" />
                        <br />
                        请不要多于50字!
                    </td>
                    <tr>
                ...
                <tr>
                    ...
                    <td><textarea  class="form-control" id="info" name="info"  style="width:400px; height:125px" ><?php if($vo['info'] == ''): ?>亲，请点击进入大转盘抽奖活动页面，祝您好运哦！<?php else: echo ($vo["info"]); endif; ?></textarea><br />换行请输入
                        &lt;br&gt;
                    </td>
                </tr>
                <tr>
    ...
    <table style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            <tr>
                ...
                <td><input type="input" class="form-control" id="endtite" value="<?php if($vo['endtite'] == ''): ?>幸运大转盘活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
                <br />
            请不要多于50字! </td>
            <td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="pic2_src" src="<?php if($vo['endpicurl'] == ''): echo ($cfg_siteUrl); ?>//Public/static/Wap/css/guajiang/images/activity-lottery-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
                <input class="form-control" id="pic2"  name="endpicurl" value="<?php if($vo['endpicurl'] == ''): echo ($cfg_siteUrl); ?>//Public/static/Wap/css/guajiang/images/activity-lottery-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  style="width:363px;"  />
                <br />
...
<tr>
<th valign="top"><span class="red">*</span>每人最多中奖次数：</th>
<td><input type="input" class="form-control" id="maxgetprizenum" name="maxgetprizenum"   value="<?php echo ($vo["maxgetprizenum"]); ?>" style="width:150px"/></td>
</tr>
<tr>
...
<tr>
<th>&nbsp;</th>
<td><button type="submit" class="btn btn-primary" ><i class="mdi-content-save"></i>保存</button>　<a href=""  class="btn btn-primary"><i class="mdi-navigation-cancel"></i>取消</a>　<span class="red">请确认功能管理已开启大转盘功能</span></td>
</tbody>
</table>
