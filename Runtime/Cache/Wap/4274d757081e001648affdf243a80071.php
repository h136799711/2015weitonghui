...
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/125/gooraye-ui-1-1.css" media="all">
 
 <!-- <link rel="stylesheet" type="text/css" href="/Public/Wap/css/125/home-0.css" media="all"> -->
 <link href="/Public/Wap/css/allcss/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css?v1" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/Public/Wap/css/125/maivl.js"></script>
<script type="text/javascript" src="/Public/Wap/css/116/jQuery.js"></script>
<script type="text/javascript" src="/Public/Wap/css/125/swipe.js"></script>
<script type="text/javascript" src="/Public/Wap/css/125/zepto.js"></script>
...
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/125/font-awesome.css" media="all">

<div class="gooraye-page" style="display:block; ">
...
<header>
        ...
        用户分类管理
        -->
        <div class="gooraye-content">
            <div class="gooraye-list">
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['status'] == 1 ): ?><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" class="gooraye-list-item">
                            <div class="gooraye-list-item-bg">
                            <div>
                                <img src="<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["name"]); ?>" style="width:100%;">
                            </div>
                            <div class="gooraye-list-item-box">
                                <div class="gooraye-list-item-line">
                                    <div class="gooraye-list-item-title"><?php echo ($vo["name"]); ?></div>
                                </div>
                            </div>
                        </div>
