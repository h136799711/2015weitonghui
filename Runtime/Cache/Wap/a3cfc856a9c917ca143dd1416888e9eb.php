		...
		<ul class="list_ul">
			<li>
				<a href="<?php echo U('Repast/selectTable', array('token'=>$token, 'wecha_id' => $wecha_id, 'cid' => $cid, 'takeaway' => 2));?>">
					<figure>
						<div style="background-image:url(/Public/static/repast/images/1.jpg);">&nbsp;</div>
			...
			<li>
				<a href="<?php echo U('Repast/selectTable', array('token'=>$token, 'wecha_id' => $wecha_id, 'cid' => $cid, 'takeaway' => 0));?>">
					<figure>
						<div style="background-image:url(/Public/static/repast/images/dincan.jpg);">&nbsp;</div>
			...
			<?php if($istakeaway == 1): ?><li>
				...
				<figure>
					<div style="background-image:url(/Public/static/repast/images/waimai.jpg);">&nbsp;</div>
