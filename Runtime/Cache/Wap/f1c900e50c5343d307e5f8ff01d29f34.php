...
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/127/common.css" media="all"> 
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/127/reset.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="/Public/Wap/css/127/home-16.css" media="all"> -->
<script type="text/javascript" src="/Public/Wap/css/127/maivl.js"></script>
<script type="text/javascript" src="/Public/Wap/css/116/jQuery.js"></script>
<script type="text/javascript" src="/Public/Wap/css/127/swipe.js"></script>
<script type="text/javascript" src="/Public/Wap/css/127/zepto.js"></script>
...
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/127/font-awesome.css" media="all">
...
<header>
        ...
        <section>
            <ul class="list_font">
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['status'] == 1 ): ?><li>
