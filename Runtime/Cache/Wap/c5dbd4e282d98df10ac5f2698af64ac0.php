...
<link rel="stylesheet" type="text/css" href="/Public/static/repast/css/wei_dialog.css" media="all" />
<link rel="stylesheet" type="text/css" href="/Public/static/repast/css/wei_canyin.css" media="all" />
<link rel="stylesheet" type="text/css" href="/Public/static/repast/css/home.css" media="all">
<script type="text/javascript" src="/Public/static/repast/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/Public/static/repast/js/wei_webapp_v2_common.js"></script>
</head>
<link rel="stylesheet" type="text/css" href="/Public/static/repast/css/jquery-ui.css" media="all" />
<script type="text/javascript" src="/Public/static/repast/js/jquery-ui.js"></script>
<script type="text/javascript" src="/Public/static/repast/js/jquery-ui-timepicker-addon.js"></script>
<script src="/Public/static/repast/js/jquery-ui-timepicker-zh-CN.js" type="text/javascript"></script>
        ...
        <form id="form_dish" action="<?php echo U('Repast/saveUser', array('token' => $token, 'wecha_id' => $wecha_id, 'cid' => $cid));?>" method="post" target="hide">
            <table class="table_book">
                ...
                <?php if($takeaway == 1): ?><tr id="dishaddress">
                    ...
                    <td>
                        <textarea name="address"  id="address"  placeholder="(必填*)送餐地址"  style="height:60px;" maxlength="100"><?php echo ($address); ?></textarea>
...
.top_bar .top_menu>li.home a { height: 66px; width: 66px; margin: auto; border-radius: 60px; position: relative; top: -22px; left: 2px; background: url('/Public/Wap/images/home.png') no-repeat center center; background-size: 100% 100%; }
...
<div class="top_bar" id="footer_menu">
	<ul id="top_menu" class="top_menu">
		<li><a href="<?php echo U('Index/index', array('token'=>$token, 'wecha_id'=>$wecha_id));?>"><img src="/Public/User/images/photo/plugmenu6.png"><label>首页</label></a></li>
		<li><a href="<?php echo U('Repast/index', array('token'=>$token, 'wecha_id'=>$wecha_id));?>"><img src="/Public/User/images/photo/plugmenu5.png"><label>选择</label></a></li>    
		<li><a onclick="t(1, '<?php echo U('Repast/dish', array('token'=>$token, 'wecha_id'=>$wecha_id, 'cid'=>$cid));?>');"><img src="/Public/User/images/photo/plugmenu11.png"><label>点菜</label></a></li>
		<li><a onclick="javascript:displayit(3)" id="childmenu"><img src="/Public/User/images/photo/plugmenu2.png"><label>我的</label></a>
			<ul id="menu_list3" class="menu_font" style=" display:none">
				<li><a onclick="t(3, '<?php echo U('Repast/myOrder', array('token'=>$token, 'wecha_id'=>$wecha_id, 'cid'=>$cid));?>');"><img src="/Public/User/images/photo/plugmenu4.png"><label>我的订单</label></a></li>
				<li><a onclick="t(4, '<?php echo U('Repast/like', array('token'=>$token, 'wecha_id'=>$wecha_id, 'cid'=>$cid));?>');"><img src="/Public/User/images/photo/plugmenu18.png"><label>我的喜欢</label></a></li>
			</ul>
		</li>
...
$(function() {
    $('#submit_form').click(function() {
    	if (takeaway != 2) {
	        ...
	        if (takeaway!= 1 && null == $('#nums').val().match(/^[0-9]*[1-9][0-9]*$/)) {
