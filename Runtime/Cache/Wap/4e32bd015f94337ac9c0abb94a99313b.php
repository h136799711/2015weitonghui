...
<html>
    <head>
        <meta charset="utf-8" />
        <link rel="stylesheet" type="text/css" href="/Public/static/goldenEgg/wap/style/css/reset.css" media="all" />
<link rel="stylesheet" type="text/css" href="/Public/static/goldenEgg/wap/style/css/main.css" media="all" />
<link rel="stylesheet" type="text/css" href="/Public/static/goldenEgg/wap/style/css/dialog.css" media="all" />
<script type="text/javascript" src="/Public/static/goldenEgg/wap/style/js/zepto.js"></script>
<script type="text/javascript" src="/Public/static/goldenEgg/wap/style/js/dialog_min.js"></script>
<script type="text/javascript" src="/Public/static/goldenEgg/wap/style/js/player_min.js"></script>
<script type="text/javascript" src="/Public/static/goldenEgg/wap/style/js/main.js"></script>
...
document.addEventListener("DOMContentLoaded", function(){
	...
	//
	var audio = new Audio();
	audio.src = "/Public/static/goldenEgg/wap/smashegg.mp3";
		...
		<?php if($wecha_id != ''): ?>handleEvent: function(evt){
				...
				setTimeout(function(){
					...
					$.ajax({
						...
						url: "<?php echo U('Wap/GoldenEgg/getajax');?>",
						type: "POST",
						dataType: "json",
						async:true,
						...
						success: function(res){
							...
							setTimeout(function(){
								if(1 == res.success){
									var urls = ["/Public/static/goldenEgg/wap/coin.png"];
									getCoin(urls);
									jg(res.data);
								}else{
									if(1 == res.error){
...
<div class="body pb_10">
		...
		<a href="javascript:;" id="playbox" class="btn_music" onclick="playbox.init(this).play();" ontouchstart="event.stopPropagation();"></a><audio id="audio" loop src="http://oss.8raw.com/eggbgmusic.mp3"  style="pointer-events:none;display:none;width:0!important;height:0!important;"></audio>
	</div>
	<section class="stage">
		<img src="/Public/static/goldenEgg/wap/style/images/stage.jpg" />
		 <div id="shape" class="cube on">
	      ...
	      <div id="hit" class="hit"><img src="/Public/static/goldenEgg/wap/style/images/1.png" /></div>
	</section>
		<section>
		...
		d1.open({
			...
			btns:[
				{id:"", name:"确定", onclick:"fn.call();", fn: function(self){
					...
					$.post("<?php echo U('Wap/Lottery/exchange');?>", obj,
					function(data) {
			...
			btns:[
				{id:"", name:"领取", onclick:"fn.call();", fn: function(self){
					...
					$.ajax({
						...
						url:"<?php echo U('Wap/Lottery/add');?>",
						type:"POST",
						data:obj,
						dataType: "json",
						success: function(res){
	...
	function lqcg(){
		...
		d5.open({
			...
			content:'<div class="header"><h6>成功领取</h6></div>\
				<table><tr>\
					<td><img src="/Public/static/goldenEgg/wap/style/images/7.png" /></td>\
	...
	function lqsb(){
		...
		d6.open({
			...
			content:'<div class="header"><?php echo ($lottery["aginfo"]); ?></div>\
				<table><tr>\
					<td><img src="/Public/static/goldenEgg/wap/style/images/8.png" /></td>\
				</tr></table>',
			btns:[
...
window.shareData = {  
            ...
            "sendFriendLink": "<?php echo ($cfg_siteUrl); echo U('GoldenEgg/index',array('token'=>$token,'id'=>$lottery['id']));?>",
