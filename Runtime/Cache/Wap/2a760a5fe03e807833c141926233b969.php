<?php if (!defined('THINK_PATH')) exit();?><html>
 ...
 <title><?php echo ($tpl["wxname"]); ?></title>
		...
		media="all">
		<!-- <link href="/Public/Wap/css/114/cate14_.css" rel="stylesheet"
		type="text/css"> -->
		<link href="/Public/Wap/css/allcss/cate14_2.css" rel="stylesheet"
		type="text/css" />
		<!--背景音乐start-->
		...
		<!--背景音乐end-->
		<script src="/Public/Wap/css/114/iscroll.js" type="text/javascript">
		</script>
		<script type="text/javascript">
			var myScroll;
...
<span id="playbox" class="btn_music" onclick="playbox.init(this).play();"><audio id="audio" loop src="<?php echo ($homeInfo["musicurl"]); ?>"></audio></span><?php endif; ?></div>
		<div class="banner">
