...
<head>
	<meta charset="utf-8" />
	<title><?php echo $thisCompany['name'];?>_<?php echo ($metaTitle); ?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" />
	<meta name="format-detection" content="telephone=no" />
	<link type="text/css" rel="stylesheet" href="/Public/Wap/css/product/css/style.css" />
	<script src="/Public/Wap/css/product/js/jquery.min.js" type="text/javascript"></script>
...
window.shareData = {  
            ...
            "sendFriendLink": "<?php echo ($cfg_siteUrl); echo U('Company/map',array('token'=>$token,'latitude'=>$_GET['latitude'],'longitude'=>$_GET['longitude'],'companyid'=>$thisCompany['id']));?>",
