...
<html lang="zh-CN">
 ...
 <link href="/Public/Wap/css/store/3css/style.css" rel="stylesheet">
 <link href="/Public/Wap/css/store/3css/templates.css" rel="stylesheet">

 </head>
 <body>
<div class="lay_header" style="height: 45px">
   <div class="lay_toptab mod_tab" id="lay_head"> <a class="tab_item" href="<?php echo U('Store/cats',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'dining'=>$isDining));?>"><img src="/Public/Wap/css/store/images/back.png" style="margin-top:11px"></a> 
    <!--<div class="tab_item go_back"><i class="qb_icon icon_goback"></i></div>--> 
    
    <a class="tab_item" href="<?php echo U('Store/my',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'dining'=>$isDining));?>"><img src="/Public/Wap/css/store/images/my.png" style="margin-top:11px"></a> <a class="tab_item" href="<?php echo U('Store/cart',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'dining'=>$isDining));?>"><img src="/Public/Wap/css/store/images/car.png" style="margin-top:11px"><i class="qb_icon icon_number_bubble qb_none"></i></a> </div>
   <div class="lay_toptab mod_tab fixed qb_none" id="lay_head_fixed"> <a class="tab_item" href="#"><i class="qb_icon icon_goback"></i></a> 
...
<div class="lay_page ">
   <div class="lay_page_wrap">
    <div class="fn_indexad">
       <div class="mod_clipimg" tag="indexad" style="width: 100%; height: 100%; "><img src="<?php echo ($date["picurls1"]); ?>" class="ui_fluid default"  ></div>
       <!--加class .animate-->
...
©<?php echo ($siteCopyright); endif; ?></div>
    ...
    <script type="text/javascript" src="/Public/Wap/css/store/3js/ChatFloat.js"></script> 
    <script>
    new ChatFloat({
        AId:127739,
        right:0,
...
<script src="/Public/Wap/css/store/3js/zepto.min.js"></script> 
...
function doDgooraye(){  
    ...
    for( var i = 0, len = imglist.length; i < len; i++){  
        DgoorayeImage(imglist[i],_width,_height);  
    }  
}  
  
function DgoorayeImage(ImgD,_width,_height){   
    var image=new Image();   
    image.src=ImgD.src;   
