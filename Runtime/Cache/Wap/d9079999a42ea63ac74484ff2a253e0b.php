...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="/Public/Wap/css/allcss/cate6_2.css" rel="stylesheet"
		type="text/css" />
		<link href="/Public/Wap/css/106/iscroll.css" rel="stylesheet"
		type="text/css" />
		...
		<style>
			.todayList li.only4 a { padding: 5px 40px 4px 5px; } .todayList li .img
			{ border-radius: 3px; height: 60px;/*图片高度*/ width: 60px;/*图片宽度*/ margin:
			0 10px 0 0; } .todayList li img { width: 60px;/*图片宽度*/ } .todayList li
			p.onlyheight { height: 32px;/*分类描述*/ } .todayList li.only4 p { white-space:
			normal; }
		</style>
		<script src="/Public/Wap/css/106/iscroll.js" type="text/javascript">
		</script>
		<script type="text/javascript">
			var myScroll;
