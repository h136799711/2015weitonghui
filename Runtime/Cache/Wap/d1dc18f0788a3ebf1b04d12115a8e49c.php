...
<link href="/Public/Wap/css/allcss/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
        ...
        <!-- <link rel="stylesheet" type="text/css" href="/Public/Wap/css/117/common.css" media="all"> -->
        <link rel="stylesheet" type="text/css" href="/Public/Wap/css/117/reset.css" media="all">
        <link rel="stylesheet" type="text/css" href="/Public/Wap/css/117/font-awesome.css" media="all">
        <!-- <link rel="stylesheet" type="text/css" href="/Public/Wap/css/117/home-51.css" media="all"> -->
...
.body{
    display:block;
    /*background:url("<?php if($homeInfo["homeurl"] != false): echo ($homeInfo["homeurl"]); else: ?>/Public/Wap/images/themes/bg1.jpg<?php endif; ?> ") no-repeat center 0;*/
