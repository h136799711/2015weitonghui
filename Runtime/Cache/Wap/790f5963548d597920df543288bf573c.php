...
<link href="/Public/static/tpl/194/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul  class="mainmenu">
	 ...
	 <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><li>
			...
			<a href="<?php if($hostlist['url'] == ''): echo U('Wap/Store/products',array('catid'=>$hostlist['id'],'token'=>$hostlist['token'],'wecha_id'=>$wecha_id)); else: echo (htmlspecialchars_decode($hostlist["url"])); endif; ?>" >
