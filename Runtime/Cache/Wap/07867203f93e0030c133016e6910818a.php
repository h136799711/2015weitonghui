...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="/Public/static/luckyFruit/wap/jquery.css">
    <link rel="stylesheet" href="/Public/static/luckyFruit/wap/tigerslot.css">
    <script src="/Public/static/luckyFruit/wap/jquery-1.js"></script>
    <script src="/Public/static/luckyFruit/wap/jquery.js"></script>
    <script src="/Public/static/luckyFruit/wap/alert.js"></script>
    <?php if($wecha_id == ''): else: ?>
    <script src="/Public/static/luckyFruit/wap/tigerslot.js"></script><?php endif; ?>
...
window.shareData = {  
            ...
            "sendFriendLink": "<?php echo ($cfg_siteUrl); echo U('LuckyFruit/index',array('token'=>$token,'id'=>$lottery['id'],'type'=>5));?>",
