...
<link rel="stylesheet" type="text/css" href="/Public/static/vhouse/online_booking.css" media="all">
<link rel="stylesheet" type="text/css" href="/Public/static/vhouse/wap/common.css" media="all">
<link rel="stylesheet" type="text/css" href="/Public/static/vhouse/wap/datepicker_car.css" media="all">
<link rel="stylesheet" type="text/css" href="/Public/static/vhouse/style-ui.css" media="all">
<link rel="stylesheet" type="text/css" href="/Public/static/vhouse/common.css" media="all">
<script type="text/javascript" src="/Public/static/vhouse/jQuery.js"></script>
<script type="text/javascript" src="/Public/static/vhouse/jquery-ui.js"></script>
<script type="text/javascript" src="/Public/static/vhouse/wap/bootstrap-datepicker.js"></script>
<title><?php echo ($reslist['title']); ?></title>
    ...
    <div class="qiandaobanner">
        <img src="<?php echo ((isset($reslist['picurl']) && ($reslist['picurl'] !== ""))?($reslist['picurl']):'http://image.gooraye.com/yicms/2013/12/24/1387856692_5a4e28182dd3a663.jpg'); ?>">
    </div>
    ...
    <!--后台可控制是否显示-->
    <ul class="round">
        <li class="addr"><a href="{gr-U('Wap/Map/location')}?lng=<?php echo ($reslist['lng']); ?>&lat=<?php echo ($reslist['lat']); ?>&title=预约&info=温馨提示：预约时间保留当天，请认真填写预约订单"><span>地址： <?php echo ($reslist['address']); ?></span></a></li>
            ...
            <table class="kuang" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="uid" id="uid" value="{gr-I('wecha_id')}">
