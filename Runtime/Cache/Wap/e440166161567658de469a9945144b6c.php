...
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/119/reset.css" media="all">
<link rel="stylesheet" type="text/css" href="/Public/Wap/css/119/font-awesome.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="/Public/Wap/css/119/home-46.css" media="all"> -->
<script type="text/javascript" src="/Public/Wap/css/116/jQuery.js"></script>
<script type="text/javascript" src="/Public/Wap/css/119/zepto.js"></script>
<script type="text/javascript" src="/Public/Wap/css/119/swipe.js"></script>
...
<span id="playbox" class="btn_music" onclick="playbox.init(this).play();"><audio id="audio" loop src="<?php echo ($homeInfo["musicurl"]); ?>"></audio></span><?php endif; ?>
    ...
    <section>
        <div>
            <ul class="list_ul">
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%2 == 1): ?><li class="box"><?php endif; ?>
							<dl>
							...
							<dd>
								<span>
									<img src="<?php echo ($vo["img"]); ?>" class="icon-smile" style="width:60px;height:40px;margin-top:5px;">
								</span>
							</dd>
							<dt style="font-size:11px;"><?php echo ($vo["name"]); ?></dt>
								</a>
							</dl>
