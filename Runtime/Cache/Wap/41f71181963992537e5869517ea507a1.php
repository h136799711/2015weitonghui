...
<meta charset="utf-8">
<link href="/Public/static/tpl/1114/css/cate.css" rel="stylesheet" type="text/css" />
 <link href="/Public/static/tpl/com/css/iscroll.css" rel="stylesheet" type="text/css" />
<script src="/Public/static/tpl/com/js/jquery.min.js" type="text/javascript"></script>
<script src="/Public/static/tpl/com/js/swipe.js" type="text/javascript"></script>
...
<div class="banner">
  <div id="wrapper">
    <div id="scroller">
      <ul id="thelist">
				<?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li><p><?php echo ($so["info"]); ?></p><a href="<?php if($so['url'] == ''): echo U('Wap/Index/flash',array('token'=>$so['token'])); else: echo (htmlspecialchars_decode($so["url"])); endif; ?>"><img src="<?php echo ($so["img"]); ?>" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>       
      </ul>
    </div>
  </div>
    <div id="nav">
...
<section>
  <nav class="nav_for_list_ul">
    <div class="ofh">
      <ul>
			<?php $__FOR_START_54656823__=4;$__FOR_END_54656823__=count($info);for($i=$__FOR_START_54656823__;$i < $__FOR_END_54656823__;$i+=1){ ?><li <?php if($i == 4): ?>class="on"<?php endif; ?>></li><?php } ?>
              </ul>
      <ul>
