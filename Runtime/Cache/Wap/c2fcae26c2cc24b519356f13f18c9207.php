<?php if (!defined('THINK_PATH')) exit();?><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		...
		<link href="/Public/Wap/css/109/iscroll.css" rel="stylesheet" type="text/css" />
        <link href="/Public/Wap/css/allcss/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
		
       <!--  <link rel="stylesheet" type="text/css" href="/Public/Wap/css/114/iscroll.css" media="all"> -->
        <script type="text/javascript" src="/Public/Wap/css/114/iscroll.js"></script>
...
<span id="playbox" class="btn_music" onclick="playbox.init(this).play();"><audio id="audio" loop src="<?php echo ($homeInfo["musicurl"]); ?>"></audio></span><?php endif; ?>
    ...
    <?php if(is_array($flashbg)): $i = 0; $__LIST__ = $flashbg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li>
        ...
        <!-- <div class="mainbg">
                <img src="<?php if($homeInfo["homeurl"] != false): echo ($homeInfo["homeurl"]); else: ?>/Public/Wap/images/themes/bg1.jpg<?php endif; ?> "/>
        </div> -->
        <!-- <div class="mainbg">
