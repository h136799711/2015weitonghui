...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		/>
		<link href="/Public/static/tpl/1265/css/cate.css" rel="stylesheet" type="text/css"
		/>
		<style>
		</style>
...
<?php if($i%4== 0 || $i == count($info) ): ?></div></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
			...
			<script src="/Public/static/tpl/com/js/jquery-1.10.1.min.js" type="text/javascript">
			</script>
			<script src="/Public/static/tpl/com/js/idangerous.swiper-2.1.min.js" type="text/javascript">
			</script>
