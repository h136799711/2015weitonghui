		...
		<?php else: ?>
			...
			<table class="table table-condensed table-bordered table-striped"  width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="mp" class="form-control empty" size="45" value="<?php echo ($info["mp"]); ?>" />
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>邮箱：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="email" class="form-control empty" size="45" value="<?php echo ($info["email"]); ?>" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="wechat_card_num" class="form-control empty" size="45" value="<?php echo ($info["wechat_card_num"]); ?>">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>会员卡数量：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="card_num" class="form-control empty" size="45" value="<?php echo ($info["card_num"]); ?>">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>活动创建数：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="activitynum" class="form-control empty" size="45" value="<?php echo ($info["activitynum"]); ?>">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>资金余额：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="moneybalance" class="form-control empty" size="45" value="<?php echo ($info["moneybalance"]); ?>">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>附件大小：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="attachmentsize" class="form-control empty" size="45" value="<?php echo $info['attachmentsize'];?>"> <?php echo $info['attachmentsize']/(1024*1024);?> M
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>短信数：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="smscount" class="form-control empty" size="45" value="<?php echo $info['smscount'];?>">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>到期时间：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="viptime" onClick="WdatePicker()" class="form-control empty" size="45" value="<?php echo (date("Y-m-d",$info["viptime"])); ?>">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<a href="U('Admin/Users/index',array('inviter'=>$info['id']))">点击查看邀请列表（共<?php echo ($inviteCount); ?>人）</a>
					</td>
				</tr>
	<tr>
		<td colspan="4">
