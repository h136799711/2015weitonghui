...
class TenpayComputerController extends BaseController{
	public $token;
	public $wecha_id;
	public $payConfig;
	...
	public function pay(){
		...
		$notify_url = C('site_url').U('Wap/TenpayComputer/notify_url');
		//需http://格式的完整路径，不能加?id=123这类自定义参数
		//页面跳转同步通知页面路径
		$return_url = C('site_url').U('Wap/TenpayComputer/return_url',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'from'=>$_GET['from']));
