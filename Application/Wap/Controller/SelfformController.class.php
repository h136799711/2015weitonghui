...
class SelfformController extends WapController{
	public $token;
	public $wecha_id;
	...
	public function index(){
		...
		if (IS_POST){
			...
			if ($submitInfo){
				...
				//二维码图片
				$imgSrc=generateQRfromGoogle(C('site_url').U('Wap/Selfform/submitInfo',array('id'=>$thisForm['id'],'token'=>$this->token,'keyword'=>$key)));
