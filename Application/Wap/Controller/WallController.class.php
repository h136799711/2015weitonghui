...
class WallController extends WapController{
	public $wall_model;
	public $wecha_id;
	public $token;
	...
	public function index(){
		...
		if (IS_POST){
			...
			if ($thisWall){
				...
				$wallRow['portrait']=I('post.portrait');//need update
				$wallRow['nickname']=I('post.nickname');//need update
				$wallRow['mp']=I('post.mp');//need update
				$wallRow['time']=time();
