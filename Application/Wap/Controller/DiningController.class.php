...
class DiningController extends WapController{
	public $token;
	public $wecha_id;
	...
	public function _initialize(){
		...
		$this->product_cart_model=M('ProductCart');
		$this->product_cart_list_m = M('ProductCart_list');
...
<span id="order_totalprice">'.$totalPrice.'</span>
	...
	function submitorders(){
		...
		$this->redirect('Mall/myOrders',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));
	}
