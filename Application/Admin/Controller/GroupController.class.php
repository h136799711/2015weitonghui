...
class GroupController extends AdminController
{
    ...
    public function access() {
        ...
        <td style='padding-left:30px;'>\$spacer <div  class='checkbox'><label><input type='checkbox' name='nodeid[]' value='\$id' class='radio' level='\$depth' \$checked onclick='javascript:checknode(this);'/ > \$title (\$name)</label></div></td>
                </tr>";
