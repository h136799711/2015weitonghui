...
class AttachmentController extends UserController{
	...
	public function files(){
		...
		'lightmusic'=>array(
				'name'=>'轻音乐',
				'files'=>array(array('file'=>'11.mp3','name'=>'I’m waiting for you'),array('file'=>'12.mp3','name'=>'钢琴曲-极度放松睡眠'),array('file'=>'13.mp3','name'=>'钢琴曲 - 天鹅湖'),array('file'=>'14.mp3','name'=>'雨的印记'), array('file' =>'15.mp3' , 'name'=>'最好听的钢琴曲'))
				),
		);
